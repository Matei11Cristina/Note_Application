...
<div class="w3-top">
  ...
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    ...
    <a href="plans.jsp" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Plans</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
        <form method="post" action="tags.jsp" >
        <input type="text" name="tag_search" placeholder="Search for a tag">
        <input type = "submit" value ="Search" name ="Submit" />
        </form>
    <% String tag_search=request.getParameter("tag_search");
        List<Notes> tags=TagDAO.getInstance().getTagNote(tag_search);%>
        <h2></h2><br>
<% 
for(Notes tag : tags) {%>
<div class="note"> 
    <h3><% out.println(tag.getName()); %></h3>
        
        <br>
        <a href="view.jsp?id=<%out.println(tag.getId());%>">View Note</a>
   </div>
    <% } %>
