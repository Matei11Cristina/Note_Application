<%-- 
    Document   : trash
    Created on : 17-May-2019, 17:15:35
    Author     : cristina
--%>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    ...
    <% String user = (String) request.getSession().getAttribute("USER");
        List<Notes> notes=NoteDAO.getInstance().getNoteStatus(user);%>
        <h2>Trash</h2><br>
<% 
...
<div class="note"> 
    <h3><% out.println(note.getName()); %></h3>
        ...
        <a href="RestoreController?id=<%out.println(id);%>">Restore Note</a>
        <a href="deleteController?id=<%out.println(id);%>">Delete Note</a>
   </div>
    <% } %>
