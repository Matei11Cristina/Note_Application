...
<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    ...
    <a href="#" class="w3-bar-item w3-button w3-hide-small w3-hover-white">MyNotebook</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    ...
    <form method="POST" action="editController?id=<%out.println(id);%>" enctype="multipart/form-data">
        <div class="form">
            <input type="text" placeholder="Name" name="name" value="<%out.println(note.getName());%>"/>
        </div>
        <div class="form">
        <textarea rows="4" cols="50" name="content" placeholder="Type..."/><%out.println(note.getDescription());%></textarea>
        </div>
        <div> 
